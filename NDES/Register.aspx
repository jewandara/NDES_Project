<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="NDES.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form class="form-vertical register-form">
		<h3 >REGISTER ACCOUNT</h3>
            ...
            <asp:Panel ID="ndesRegisterPanelOne" runat="server">
			        ...
			        <div class="control-group">
				        ...
				        <div class="controls">
					        <div class="input-icon left">
						        ...
						        <input class="m-wrap placeholder-no-fix" type="text" placeholder="Contact Number" name="cNumber"/>
					        </div>
				        </div>
			        </div>
			        ...
			        <div class="form-actions">
                        <asp:Button ID="nextButton" runat="server" CssClass="btn pull-right" Text=" NEXT " onclick="nextButton_Click" />    
			        </div>    
            </asp:Panel>

  
            <asp:Panel ID="ndesRegisterPanelTwoSubmit" runat="server" Visible="False">
                    ...
                    <div class="form-actions">
                        ...
                        <asp:Button ID="submitForm" runat="server" Text="SIGN UP" CssClass="btn green pull-right" />
			        </div>
            </asp:Panel>
